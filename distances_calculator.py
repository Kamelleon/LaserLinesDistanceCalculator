...
class DistancesCalculator:
    def __init__(self, referenced_object_real_width=1, referenced_object_pixel_width=1, distance_sampling_multiplier=30):
        self.image = None
    ...
    def calculate_distances_between_laser_lines(self,
        ...
        if show_distances_on_image:
            cv2.imwrite(f"distances_on_image_{self.number_of_scan}.jpg", self.image)
