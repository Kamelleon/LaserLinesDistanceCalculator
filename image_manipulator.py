...
class ImageManipulator:
    def __init__(self):
        ...
        # self.lower_green_mask = array([10, 80, 120])
    ...
    def preprocess_frame(self, frame, min_threshold_for_edge_detection=10,max_threshold_for_edge_detection=1000, get_masked_frame=True):
